...
import { FaChevronDown, FaPhoneAlt, FaSearch, FaShoppingCart } from 'react-icons/fa';
    ...
    <div>
      <div className="header-home">
        ...
        <div className="nav">
          ...
          >
            Sản phẩm <i className='icon-down'><FaChevronDown /></i>
            {showDropdown && (
          ...
          {products.map(product => (
            <div key={product.id} className="box">
              <div className="box-img">
                <img className='img-products' src={product.images} alt={product.name} />
              </div>
